...
public:
    ...
    vector<TransitionRegion> getTopTransitionRegions(Mat &image);
    vector<TransitionRegion> getBottomTransitionRegions(Mat &image);
    vector<TransitionRegion> getLeftTransitionRegions(Mat &image);
    vector<TransitionRegion> getRightTransitionRegions(Mat &image);
