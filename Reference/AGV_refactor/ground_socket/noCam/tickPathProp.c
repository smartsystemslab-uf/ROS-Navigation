...
int main()                                    // main function
{
    ...
    while(1){
        ...
        while(goPin )                                    // Endless loo  p
        {
            ...
            while(currentStep < lastStep && goPin){

                if(pathLeft[currentStep] == pathRight[currentStep]){
                    while(goPin && traveledLeft != pathLeft[currentStep] && traveledRight != pathRight[currentStep]){
...
//    }
               ...
               if(traveledLeft != pathLeft[currentStep] && traveledRight != pathRight[currentStep]) {
                   currentStep++;
               }
            ...
            if(pathComplete == 0 && currentStep >= lastStep ){
